...
eval gsed -e 's/{BACKEND_NAME}/$BACKEND_NAME/g' example/docker-compose.development.yml | eval gsed -e 's/{PROJECT_NAME}/$PROJECT_NAME/g'  > ./docker-compose.development.yml;
rm -rf example;